        ...
        <div className={styles.container}>
          <div className="flex items-center justify-center px-44">
            ...
            <div>
              ...
              <div className="mt-10">
                <p className="font-bold text-primary">Learn more about OpeanSea</p>
              </div>
            </div>
          ...
          <div className="text-center mt-44 px-44">
            ...
            <div className="grid grid-cols-4 gap-5 mt-20">
              <div className="px-3">
                ...
                <div className="font-normal text-gray-500 mt-3">Once you’ve set up your wallet of choice, connect it to OpenSea by clicking the wallet icon in the top right corner. Learn about the <span className="text-primary font-semibold">wallets we support</span>.</div>
              </div>
              <div className="px-3">
                <div className="font-bold">Icon</div>
            ...
            <div className="grid grid-cols-3 gap-5 mt-20">
              ...
              <div className="bg-white border rounded-lg">
                <figure className="p-0">
                  ...
                  <div className="px-5 my-5">
                    <h1 className="font-semibold text-xl">Keeping yourself safe when buying NFTs on OpenSea</h1>
                  </div>
          ...
          <div className="text-center mt-48 px-44">
            <h1 className="font-semibold text-4xl">Meet OpenSea</h1>
